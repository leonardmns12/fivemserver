...
local fareCost = 30.66 --(1.66 = $100 per minute) Cost per second
local costPerMile = 500.0
local initialFare = 500.0 -- the cost to start a fare
    ...
    while true do
      ...
      if(IsInTaxi()) then
        if (inTaxi == false) then
          msg = "Tekan HOME untuk menyalakan argo"
