...
function JailLogin()
	...
	exports['mythic_notify']:DoHudText('error', 'Kamu kembali kedalam penjara!')	
	InJail()
end
...
function UnJail()
	...
	exports['mythic_notify']:DoHudText('inform', 'Kamu bebas dari penjara')	
...
function InJail()
	...
	Citizen.CreateThread(function()
		...
		while jailTime > 0 do
			...
			exports['mythic_notify']:DoHudText('inform', 'Kamu memiliki ' ..jailTime.. ' menit tersisa!')
					...
					if DistanceCheck <= 1.5 then
						...
						if IsControlJustPressed(0, 38) then
							...
							if v["state"] then
								...
								exports['mythic_notify']:DoHudText('inform', 'Kamu sudah mengambil paket ini!')
							end
			...
			ESX.UI.Menu.Open(
          	...
          	function(data2, menu2)
            	...
            	if jailTime == nil then
              		...
              		exports['mythic_notify']:DoHudText('error', 'Input tidak valid!')
            	else
              		menu2.close()
              		...
              		if closestPlayer == -1 or closestDistance > 3.0 then
                		...
                		exports['mythic_notify']:DoHudText('inform', 'Tidak ada player disekitar')
					else
						ESX.UI.Menu.Open(
						...
						function(data3, menu3)
						  	...
						  	if reason == nil then
								...
								exports['mythic_notify']:DoHudText('inform', 'Kamu harus menaruh sesuatu disini!')
						  	else
								menu3.close()
								...
								if closestPlayer == -1 or closestDistance > 3.0 then
								  	-- ESX.ShowNotification("No players nearby!")
								  	exports['mythic_notify']:DoHudText('error', 'Tidak ada player disekitar')
								else
		...
		elseif action == "unjail_player" then
			...
			ESX.TriggerServerCallback("esx-qalle-jail:retrieveJailedPlayers", function(playerArray)
				...
				if #playerArray == 0 then
					...
					exports['mythic_notify']:DoHudText('inform', 'Penjara kamu kosong!')
					return
				end
