...
Citizen.CreateThread(function()
	while true do
		...
		if IsPedInAnyVehicle(playerPed, false) then
			...
			local zone 		  = nil
			local lastZone    = nil
			if (PlayerData.job ~= nil and PlayerData.job.name == 'mecano' and PlayerData.job.grade_name ~= 'recrue' and PlayerData.job.grade_name ~= 'novice') or Config.IsMechanicJobOnly == false then
				for k,v in pairs(Config.Zones) do
