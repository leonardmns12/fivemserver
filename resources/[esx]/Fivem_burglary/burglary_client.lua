...
local burglaryPlaces = {
  ...
  ["Grove Street 2"] = {
   ...
   ["Grove Street 3"] = {
    door = 3,
     locked = true,
    pos = { x = 192.47 , y = -1883.49 , z = 25.06, h = 330.54 },  -- door coords
    inside = { x = 346.52, y = -1013.19, z = -99.2, h = 357.81 },  -- Inside the house coords
    animPos = { x = 192.47 , y = -1883.49 , z = 25.06, h = 330.54 }, -- The animation position
    doorTime = {}
   },
   ["Grove Street 4"] = {
    door = 3,
     locked = true,
    pos = { x = 1228.39 , y = -664.21 , z = 63.5, h = 104.99 },  -- door coords
    inside = { x = 346.52, y = -1013.19, z = -99.2, h = 357.81 },  -- Inside the house coords
    animPos = { x = 1228.39 , y = -664.21 , z = 63.5, h = 104.99 }, -- The animation position
    doorTime = {}
   },
   ["Grove Street 5"] = {
    door = 3,
     locked = true,
    pos = { x = 1099.43 , y = -438.64 , z = 67.79, h = 169.83 },  -- door coords
    inside = { x = 346.52, y = -1013.19, z = -99.2, h = 357.81 },  -- Inside the house coords
    animPos = { x = 1099.43 , y = -438.64 , z = 67.79, h = 169.83 }, -- The animation position
    doorTime = {}
   },
   ["Grove Street 6"] = {
    door = 3,
     locked = true,
    pos = { x = 1056.04 , y = -448.88 , z = 66.26, h = 160.08 },  -- door coords
    inside = { x = 346.52, y = -1013.19, z = -99.2, h = 357.81 },  -- Inside the house coords
    animPos = { x = 1056.04 , y = -448.88 , z = 66.26, h = 160.08 }, -- The animation position
    doorTime = {}
   },
   ["Grove Street 7"] = {
    door = 3,
     locked = true,
    pos = { x = 1051.08 , y = -470.41 , z = 64.3, h = 83.0 },  -- door coords
    inside = { x = 346.52, y = -1013.19, z = -99.2, h = 357.81 },  -- Inside the house coords
    animPos = { x = 1051.08 , y = -470.41 , z = 64.3, h = 83.0 }, -- The animation position
    doorTime = {}
   },
   ["Grove Street 8"] = {
    door = 3,
     locked = true,
    pos = { x = 993.79 , y = -620.68 , z = 59.04, h =130.25 },  -- door coords
    inside = { x = 346.52, y = -1013.19, z = -99.2, h = 357.81 },  -- Inside the house coords
    animPos = { x = 993.79 , y = -620.68 , z = 59.04, h =130.25 }, -- The animation position
    doorTime = {}
   }
}
