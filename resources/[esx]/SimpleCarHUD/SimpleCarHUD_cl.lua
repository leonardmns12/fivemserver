...
local cruiseInput = 9999                     -- Toggle cruise on/off with CAPSLOCK or A button (controller)
        ...
        if pedInVeh or locationAlwaysOn then
            ...
            if pedInVeh and GetIsVehicleEngineRunning(vehicle) and vehicleClass ~= 13 then
                ...
                if vehicleClass ~= 8 then
                    ...
                    drawTxt("SEATBELT", 2, seatbeltColor, 0.4, screenPosX + 0.100, screenPosY + 0.042)
                end
            end
        end
    end
