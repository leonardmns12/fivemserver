...
Citizen.CreateThread(function()
    while true do
        ...
        for k in pairs(rentbike) do
            ...
            if dist <= 0.5 then
				hintToDisplay('Tekan ~INPUT_CONTEXT~ untuk sewa ~b~sepeda')
				
				if IsControlJustPressed(0, Keys['E']) then -- "E"
					if IsPedInAnyVehicle(GetPlayerPed(-1)) then
                        --ESX.ShowNotification("You already have a ~r~vehicle")
                        exports['mythic_notify']:DoHudText('error', 'Kamu sudah punya kendaraan!')
					else
						OpenBikeMenu()
					end
				end			
...
Citizen.CreateThread(function()
    while true do
        ...
        for k in pairs(gym) do
            ...
            if dist <= 0.5 then
				hintToDisplay('Tekan ~INPUT_CONTEXT~ untuk membuka menu ~b~Gym~w~')
...
Citizen.CreateThread(function()
    while true do
        ...
        for k in pairs(arms) do
            ...
            if dist <= 0.5 then
				hintToDisplay('Tekan ~INPUT_CONTEXT~ untuk melatih ~g~tangan kamu')
				...
				if IsControlJustPressed(0, Keys['E']) then
					if training == false then
                        ...
                        exports['mythic_notify']:DoHudText('success', 'Mempersiapkan diri untuk olahraga...')
						Citizen.Wait(1000)					
						...
						if membership == true then
                            ...
                            exports['mythic_notify']:DoHudText('inform', 'Kamu harus istirahat setidaknya 1 menit sebelum melakukan olahraga lain')
						...
						elseif membership == false then
                            ...
                            exports['mythic_notify']:DoHudText('error', 'Kamu perlu gym membership sebelum menggunakan fasilitas ini!')
						end
					elseif training == true then
                        --ESX.ShowNotification("You need to rest...")
                        exports['mythic_notify']:DoHudText('inform', 'Kamu perlu istirahat...')
...
Citizen.CreateThread(function()
    while true do
        ...
        for k in pairs(chins) do
            ...
            if dist <= 0.5 then
				hintToDisplay('Tekan ~INPUT_CONTEXT~ untuk melakukan ~g~pull-up')
...
Citizen.CreateThread(function()
    while true do
        ...
        for k in pairs(pushup) do
            ...
            if dist <= 0.5 then
				hintToDisplay('Tekan ~INPUT_CONTEXT~ untuk melakukan ~g~push-up')
				...
				if IsControlJustPressed(0, Keys['E']) then
					if training == false then
						...
						elseif membership == false then
                            --ESX.ShowNotification("You need a membership in order to do a ~r~exercise")
                            exports['mythic_notify']:DoHudText('error', 'Kamu perlu gym membership untuk menggunakan fasilitas ini!')
						end							
					elseif training == true then
                        --ESX.ShowNotification("You need to rest...")
                        exports['mythic_notify']:DoHudText('inform', 'Kamu perlu istirahat...')
...
Citizen.CreateThread(function()
    while true do
        ...
        for k in pairs(yoga) do
            ...
            if dist <= 0.5 then
				hintToDisplay('Tekan ~INPUT_CONTEXT~ untuk melakukan gerakan ~g~yoga')
...
function CheckTraining()
	if resting == true then
        ...
        exports['mythic_notify']:DoHudText('inform', 'Kamu sedang istirahat...')
	...
	if resting == false then
        ...
        exports['mythic_notify']:DoHudText('success', 'Sekarang kamu siap untuk olahraga kembali...')
	end
end
...
function OpenGymMenu()
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'gym_menu',
        {
            title    = 'Gym',
            elements = {
				{label = 'Toko Gym', value = 'shop'},
				{label = 'Jam Operasional', value = 'hours'},
				{label = 'Gym Membership', value = 'ship'},
            }
        },
        function(data, menu)
            ...
            elseif data.current.value == 'hours' then
				...
				ESX.ShowNotification("Kami buka ~g~24~w~ jam/hari. Selamat berolahraga!")
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'gym_shop_menu',
        {
            ...
            elements = {
				...
				{label = 'Air Minum (Rp. 10000)', value = 'water'},
...
function OpenGymShipMenu()
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'gym_ship_menu',
        {
            ...
            elements = {
				{label = 'Membership (Rp. 80000)', value = 'membership'},
            }
        },
        function(data, menu)
...
function OpenBikeMenu()
    ...
    ESX.UI.Menu.Open(
        'default', GetCurrentResourceName(), 'bike_menu',
        {
            title    = 'Sewa Sepeda',
            elements = {
                {label = 'Cruiser (Rp. 2500)', value = 'cruiser'},
				{label = 'BMX (Rp. 5000)', value = 'bmx'},
				{label = 'Fixter (Rp. 7500)', value = 'fixter'},
				{label = 'Scorcher (Rp. 100000)', value = 'scorcher'},
            }
        },
        function(data, menu)
