		...
		elseif data.current.action == 'garage' then
			...
			ESX.TriggerServerCallback('esx_vehicleshop:retrieveJobVehicles', function(jobVehicles)
				if #jobVehicles > 0 then
						...
						if data2.current.stored then
							...
							if foundSpawn then
								...
								ESX.Game.SpawnVehicle(data2.current.model, spawnPoint.coords, spawnPoint.heading, function(vehicle)
									...
									exports['mythic_notify']:DoHudText('success', 'Kendaraan telah dikeluarkan dari garasi.')
								end)
							end
						else
							--ESX.ShowNotification(_U('garage_notavailable'))
							exports['mythic_notify']:DoHudText('error', 'Kendaraan tidak tersimpan di dalam garasi!')
					...
					exports['mythic_notify']:DoHudText('error', 'Anda tidak punya kendaraan di garasi ini')
...
function StoreNearbyVehicle(playerCoords)
	...
	if #vehicles > 0 then
		...
		exports['mythic_notify']:DoHudText('error', 'Tidak ada kendaraan terdekat')
	...
	ESX.TriggerServerCallback('esx_ambulancejob:storeNearbyVehicle', function(storeSuccess, foundNum)
		if storeSuccess then
			...
			exports['mythic_notify']:DoHudText('success', 'Kendaraan telah dimasukkan kedalam garasi')
...
function GetAvailableVehicleSpawnPoint(hospital, part, partNum)
	...
	if found then
		...
		exports['mythic_notify']:DoHudText('inform', 'Pastikan spawn point tidak terhalang!')
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'helicopter_spawner', {
		...
		if data.current.action == 'buy_helicopter' then
			...
			if #authorizedHelicopters > 0 then
				...
				exports['mythic_notify']:DoHudText('error', 'Kamu tidak kdiizinkan untuk membeli helikopter!')
				return
			end
			...
			if data2.current.value == 'yes' then
				...
				ESX.TriggerServerCallback('esx_ambulancejob:buyJobVehicle', function (bought)
					if bought then
						...
						exports['mythic_notify']:DoHudText('success', 'Anda telah membeli kendaraan')
...
AddEventHandler('esx_ambulancejob:heal', function(healType)
	...
	exports['mythic_notify']:DoHudText('success', 'Kamu telah diobati')
end)
