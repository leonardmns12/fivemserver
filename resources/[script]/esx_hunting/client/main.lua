							...
							if PlyToAnimal < 2.0 then
								...
								if IsControlJustReleased(0, Keys['E']) then
									if GetSelectedPedWeapon(PlayerPedId()) == GetHashKey('WEAPON_KNIFE')  then
										...
										exports['mythic_notify']:DoHudText('error', 'Kamu perlu pisau untuk berburu!')
									end
								end
...
function SlaughterAnimal(AnimalId)
	...
	exports['mythic_notify']:DoHudText('success', 'Kamu telah memburu hewan dan mendapatkan daging seberat ' ..AnimalWeight.. 'kg')
