        ...
        if IsAnyVehicleNearPoint(coords.x, coords.y, coords.z, 5.0) then
         ...
         --  	},
          ...
          --     },
              ...
              exports['mythic_notify']:DoHudText('success', 'Kendaraan terbuka')
            end)
          end
        ...
        if IsAnyVehicleNearPoint(coords.x, coords.y, coords.z, 5.0) then
          ...
          if DoesEntityExist(vehicle) then
            ...
            Citizen.CreateThread(function()
              ...
              exports['mythic_notify']:DoHudText('success', 'Kendaraan berhasil diperbaiki')
            end)
          end
        end
      end
        ...
        if IsAnyVehicleNearPoint(coords.x, coords.y, coords.z, 5.0) then
          ...
          if DoesEntityExist(vehicle) then
            ...
            Citizen.CreateThread(function()
              ...
              exports['mythic_notify']:DoHudText('success', 'Kendaraan selesai dibersihkan')
            end)
          end
        end
      end
        ...
        Citizen.CreateThread(function()
          while currentTask.busy do
            ...
            if not DoesEntityExist(vehicle) and currentTask.busy then
              ...
              exports['mythic_notify']:DoHudText('error', 'Penyitaan dibatalkan karena kendaraan bergerak')
      ...
      if data.current.value == 'dep_vehicle' then
        ...
        if isVehicleTow then
          ...
          Citizen.CreateThread(function()
            while true do
              ...
              if IsEntityUpsidedown(GetVehiclePedIsIn(PlayerPedId(), true)) and isVehicleTow or roll > 70.0 or roll < -70.0 then
                ...
                exports['mythic_notify']:SendAlert('error', 'Tali towing putus!')
              end        
            end
          end)
          ...
          if currentlyTowedVehicle == nil then
            if targetVehicle ~= 0 then
              ...
              if distanceBetweenVehicles > 12.0 then
                exports['mythic_notify']:SendAlert('error', "Tali tidak sampai, dekatkan kendaraan!")
              else
                ...
                if not ((not allowTowingBoats and IsThisModelABoat(targetModelHash)) or (not allowTowingHelicopters and IsThisModelAHeli(targetModelHash)) or (not allowTowingPlanes and IsThisModelAPlane(targetModelHash)) or (not allowTowingTrains and IsThisModelATrain(targetModelHash)) or (not allowTowingTrailers and isTargetVehicleATrailer(targetModelHash))) then 
                  if not IsPedInAnyVehicle(playerped, true) then
                    if vehicle ~= targetVehicle and IsVehicleStopped(vehicle) then
                      ...
                      exports['mythic_notify']:SendAlert('success', "Kendaraan berhasil diderek")
                      
                    else
                      exports['mythic_notify']:SendAlert('error', "Tidak ada kendaraan di mobil gendong/flatbed")
                    end
                  else
                    exports['mythic_notify']:SendAlert('inform', "Kamu harus berada diluar kendaraan untuk mengangkut/menurunkan kendaraan")
                  end
                else
                  exports['mythic_notify']:SendAlert('error', "Kamu tidak bisa derek mobil ini")
                end
              end
            else
              exports['mythic_notify']:SendAlert('error', "Tidak menemukan kendaraan yang bisa diderek")
            end
          elseif IsVehicleStopped(vehicle) then
            ...
            currentlyTowedVehicle = nil
            exports['mythic_notify']:SendAlert('success', _U('Berhasil menurunkan kendaraan'))
          end
        else
          exports['mythic_notify']:SendAlert('error', "Kamu perlu mobil gendong/flatbed")
        end
      end
      ...
      function(data, menu)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              exports['mythic_notify']:SendAlert('error', "Jumlah invalid")
            else
              menu2.close()
              menu.close()
              OpenGetStocksMenu()
    ...
    if DoesEntityExist(vehicle) then
      ...
      Citizen.CreateThread(function()
        ...
        if crochete <= 66 then
          ...
          exports['mythic_notify']:SendAlert('error', "Kendaraan gagal dibajak")
          ClearPedTasksImmediately(playerPed)
        end
      end)
    end
  ...
  if IsAnyVehicleNearPoint(coords.x, coords.y, coords.z, 5.0) then
    ...
    if DoesEntityExist(vehicle) then
      ...
      Citizen.CreateThread(function()
        ...
        SetVehicleDeformationFixed(vehicle)
        ClearPedTasksImmediately(playerPed)
        exports['mythic_notify']:SendAlert('success', "Bodi kendaraan berhasil diperbaiki")
      end)
    end
  end
end)
  ...
  if IsAnyVehicleNearPoint(coords.x, coords.y, coords.z, 5.0) then
    ...
    if DoesEntityExist(vehicle) then
      ...
      Citizen.CreateThread(function()
        ...
        SetVehicleUndriveable(vehicle, false)
        ClearPedTasksImmediately(playerPed)
        exports['mythic_notify']:SendAlert('success', "Kendaraan berhasil diperbaiki")
      end)
    end
  end
end)
...
function ImpoundVehicle(vehicle)
  ...
  exports['mythic_notify']:SendAlert('success', "Kendaraan sudah masuk garasi sitaan")
	currentTask.busy = false
end
...
function OpenMecanoHarvestMenu()
  ...
  if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.grade_name ~= 'recrue' then
    ...
    exports['mythic_notify']:SendAlert('error', "Kamu belum diizinkan untuk modifikasi kendaraan!")
  end
end
