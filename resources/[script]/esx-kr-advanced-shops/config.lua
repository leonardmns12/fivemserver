...
Config.Locale = 'en'
Config.DeliveryTime = 7200 -- IN SECOUNDS DEFAULT (18000) IS 5 HOURS / 300 MINUTES
...
Config.ChangeNamePrice = 150000 -- In $ - how much you can change the shops name for

-- CONFIG ITEMS, DON'T FORGET TO ADD CORRECT NUMBER IN THE BRACKETS
Config.Items = {
    [1] = {label = "Air Mineral",       item = "water",        price = 50},
