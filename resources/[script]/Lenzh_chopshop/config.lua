...
Config.Zones = {
    Chopshop = {coords = vector3(-223.572,-1329.156,30.149), name = _U('map_blip'), color = 49, sprite = 225, radius = 100.0, Pos = { x = -178.11, y = -1287.22, z = 31.4 }, Size  = { x = 1.2, y = 1.2, z = 1.0 }, },
