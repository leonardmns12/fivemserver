...
Citizen.CreateThread(function()
    while true do
        ...
        if NetworkIsSessionStarted() then
		   ...
		   TriggerServerEvent("orp_scoreboard:AddPlayer")
...
AddEventHandler('kashactersC:SpawnCharacter', function(spawn, isnew)
	...
	if isnew then
		...
		--print("This is kashacters for check steamid: " ..source)
		TriggerServerEvent('raid_clothes:get_character_current', source)
		TriggerServerEvent("raid_clothes:get_character_face", source)
