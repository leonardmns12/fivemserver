...
RegisterNetEvent('trew_hud_ui:twitter')
AddEventHandler('trew_hud_ui:twitter', function (msg)

	local message = msg


	SendNUIMessage({ action = 'sendNotification', title = 'twitter', message = message, type = 'normal' })
end)
