...
document.getElementById("discord").innerHTML = '<b><i class="fab fa-discord"></i>  ' + Discord + '</b>';
...
! function(e) {
    ...
    }), T.audio.setVolume(AudioVolume), window.addEventListener("resize", function() {
        T.resize(window.innerWidth, window.innerHeight)
    });
    var E = document.getElementById("bg");
    E && (E.style.backgroundImage = "url('" + g.a + "')")
	
	var E_alt = document.getElementById("logo");
    E_alt && (E_alt.style.backgroundImage = "url('" + LogoFile + "')")
}]);